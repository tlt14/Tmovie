    ...
    return (
        <div className="col-span-9">
            <div className="">
                ...
                {
                    !key && <iframe className="rounded" width="100%" height="500px" src={`https://www.2embed.to/embed/tmdb/movie?id=${data?.id}`} title="Cấu hình Router và xây dựng cơ chế tải Layout cho dự án Tiktok tại F8" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                }
            </div>
            <div className="content dark:text-white">
                ...
                <div className="flex items-center gap-2 pb-2">
                    <img
                        ...
                        src={`https://image.tmdb.org/t/p/original/${data?.belongs_to_collection?.poster_path || data?.backdrop_path} `}
